...
| Check | Command |
|-------|---------|
| Phase 4 done (app pods running) | `kubectl get pods -n cloudkitchen` |
| Services labelled correctly | `kubectl get svc -n cloudkitchen -l app.kubernetes.io/part-of=cloudkitchen` should list 9 services |
