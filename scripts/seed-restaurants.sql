...
-- customer UI at http://harishraodevops.in/ has content to browse.
--
...
BEGIN
  ...
  -- ========================================================================
  -- Restaurant 1 — Harishrao's Pizza (Hyderabad, Italian)
  -- ========================================================================
  INSERT INTO restaurants.restaurants (id, owner_id, name, description, address, city, status)
    VALUES (gen_random_uuid(), demo_owner, 'Harishrao''s Pizza',
