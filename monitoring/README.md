...
## URLs (replace `harishraodevops.in` with your hostname)

| UI            | URL                                                                                                |
| ------------- | -------------------------------------------------------------------------------------------------- |
| Grafana       | http://harishraodevops.in/grafana/                                                                  |
| Prometheus    | http://harishraodevops.in/prometheus/                                                               |
| Alertmanager  | http://harishraodevops.in/alertmanager/                                                             |
| Per-service dashboards | http://harishraodevops.in/grafana/d/ck-&lt;service&gt;/cloudkitchen-&lt;service&gt;                         |
